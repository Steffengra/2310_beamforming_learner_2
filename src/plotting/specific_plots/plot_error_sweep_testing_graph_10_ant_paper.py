...
if __name__ == '__main__':
    ...
    data_paths = [
        Path(cfg.output_metrics_path,
             'sat_1_ant_10_usr_3_satdist_10000_usrdist_100000', 'error_sweep',
        ...
        Path(cfg.output_metrics_path,
             'sat_1_ant_10_usr_3_satdist_10000_usrdist_100000', 'error_sweep',
             'testing_learned_0.0_error_sweep_0.0_0.1_userwiggle_50000.gzip'),
        Path(cfg.output_metrics_path,
             'sat_1_ant_10_usr_3_satdist_10000_usrdist_100000', 'error_sweep',
             'testing_learned_0.05_error_sweep_0.0_0.1_userwiggle_50000.gzip'),
    ]

    plot_width = 0.99 * plot_cfg.textwidth
    plot_height = plot_width * 9 / 20

    plot_legend = ['MMSE', 'rSLNR', 'pSAC1', 'rSAC1']
