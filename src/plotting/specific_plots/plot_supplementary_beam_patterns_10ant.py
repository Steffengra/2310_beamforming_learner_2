...
if __name__ == '__main__':
    ...
    data_path = Path(cfg.output_metrics_path,
                     'sat_1_ant_10_usr_3_satdist_10000_usrdist_100000', 'beam_patterns', 'beam_patterns.gzip')
    ...
    labels = {
        'mmse': 'MMSE',
        'slnr': 'rSLNR',
        'learned_0.0_error': 'pSAC1',
        'learned_0.5_error': 'rSAC1',
    }
    ...
    for pattern in patterns:
        ...
        plot_beam_patterns(
            ...
            name=f'10ant_realization{pattern}_supplemental',
        )
